...
class _ElderlyScreenState extends State<ElderlyScreen> {
  ...
  void _acionarSOS() {
    showDialog<void>(
      ...
      builder: (_) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        title: const Text('Emergência', style: TextStyle(fontSize: 26)),
        content: const Text(
          'Um alerta de emergência foi disparado.\nSeus contatos serão avisados.',
    ...
    SosService.trigger(motivo: 'manual');
  }
  ...
  Future<void> _criarLembretePorVoz() async {
    ...
    try {
      ...
      // Usa _horaFalada para o TTS pronunciar corretamente (ex: "12 horas e 10 minutos")
      ...
      await VoiceService.speak(
        'Lembrete de $tipo criado: $tituloLimpo$repeatFrase às $horaFalada.',
      );
    } catch (e) {
