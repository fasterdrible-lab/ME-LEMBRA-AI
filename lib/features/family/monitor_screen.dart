...
class _MonitorScreenState extends State<MonitorScreen> {
  ...
  void _marcarAlertasComoVistos(List<SosAlert> alertas) {
    if (_marcou) return;
    _marcou = true;
    for (final a in alertas) {
      if (!a.viewedBy.contains(_viewerUid)) {
        SosFeedService.markViewed(a.id, _viewerUid);
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Monitorando ${widget.member.nome}'),
        ...
        children: [
          ...
          StreamBuilder<List<SosAlert>>(
            ...
            builder: (context, snap) {
              ...
              // Marca todos como vistos na primeira carga
              WidgetsBinding.instance.addPostFrameCallback(
                  (_) => _marcarAlertasComoVistos(list));
          ...
          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snap) {
              ...
              final pct =
                  total == 0 ? 0 : (confirmados * 100 / total).round();
              return Column(
                children: [
                  Card(
                    child: Padding(
  ...
  Widget _sosTile(SosAlert a) {
    ...
    final visto = a.viewedBy.isNotEmpty;
    return Card(
